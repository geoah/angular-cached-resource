...
// Generated by CoffeeScript 1.8.0
var $cachedResourceFactory, $cachedResourceProvider, app, debugMode, forceParam, localStoragePrefix, resourceManagerListener,
  __slice = [].slice;
...
app.provider('$cachedResource', $cachedResourceProvider = (function() {
  ...
  $cachedResourceProvider.prototype.setForceParam = function(force, silenceWarning, key, prefix) {
    if (force == null) {
      force = false;
    }
    ...
    if (silenceWarning === true) {
      forceParam.silenceWarning = true;
    }
    if (key != null) {
      forceParam.key = "" + key;
    }
    if (prefix != null) {
      return forceParam.prefix = "" + prefix;
    }
  };
...
module.exports = function(providerParams) {
  ...
  return ResourceCacheArrayEntry = (function(_super) {
    ...
    ResourceCacheArrayEntry.prototype.addInstances = function(instances, dirty) {
      var cacheArrayReferences, cacheInstanceEntry, cacheInstanceParams, index, instance, _i, _len, _ref, _ref1, _ref2, _ref3;
      cacheArrayReferences = [];
      for (index = _i = 0, _len = instances.length; _i < _len; index = ++_i) {
        instance = instances[index];
        cacheInstanceParams = instance.$params();
        if (Object.keys(cacheInstanceParams).length === 0) {
          if ((((_ref = providerParams.forceParam) != null ? _ref.force : void 0) != null) !== true) {
            $log.error("instance " + instance + " doesn't have any boundParams. Please, make sure you specified them in your resource's initialization, f.e. `{id: \"@id\"}`, or it won't be cached. You can force caching for such resources with `$cachedResourceProvider.forceParam` setting.");
          } else if ((((_ref1 = providerParams.forceParam) != null ? _ref1.key : void 0) != null) && (((_ref2 = providerParams.forceParam) != null ? _ref2.prefix : void 0) != null)) {
            cacheInstanceParams["providerParams.forceParam.key"] = "" + providerParams.forceParam.prefix + "-" + index;
            if (((_ref3 = providerParams.forceParam) != null ? _ref3.silenceWarning : void 0) !== true) {
              $log.error("instance " + instance + " doesn't have any boundParams and has been forced to cache by the `$cachedResourceProvider.forceParam` setting.");
            }
          } else {
            $log.error("instance " + instance + " doesn't have any boundParams and `forceParam` setting is missing a key or prefix. Please add them for this to work.");
          }
        }
